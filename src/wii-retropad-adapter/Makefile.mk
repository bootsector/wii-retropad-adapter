...
# List C++ source files here. (C dependencies are automatically generated.)
CPPSRC = genesis.cpp main.cpp NESPad.cpp PS2X_lib.cpp wra.cpp Wire/Wire.cpp \
WMCrypt.cpp WMExtension.cpp GCPad.cpp saturn.cpp
...
EXTRAINCDIRS = ./arduinocore ./Wire ./Wire/utility
...
CDEFS = -DF_CPU=$(F_CPU)UL -DARDUINO=22 -DSATURN=$(SATURN)


# Place -D or -U options here for ASM sources
ADEFS = -DF_CPU=$(F_CPU) -DARDUINO=22 -DSATURN=$(SATURN)


# Place -D or -U options here for C++ sources
CPPDEFS = -DF_CPU=$(F_CPU)UL -DARDUINO=22 -DSATURN=$(SATURN)
